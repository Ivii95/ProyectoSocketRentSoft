...
public class Tabla extends javax.swing.JFrame implements Protocolo {
    ...
    public Tabla(java.awt.Frame parent, boolean modal) {
        ...
        UtilidadesPantalla.centrarTabla(tblPrinci, 2);
        UtilidadesPantalla.centrarTabla(tblPrinci, 3);
        UtilidadesPantalla.centrarTabla(tblPrinci, 4);
        UtilidadesPantalla.centrarTabla(tblPrinci, 5);
        UtilidadesPantalla.centrarTabla(tblPrinci, 1);
        ponLaAyuda();
